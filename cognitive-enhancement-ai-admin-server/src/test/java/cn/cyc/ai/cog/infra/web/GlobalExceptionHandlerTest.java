...
@Import(GlobalExceptionHandlerTest.WebMvcTestBootstrap.class)
class GlobalExceptionHandlerTest {
    ...
    /**
     * 避免 @WebMvcTest 拉起 {@link cn.cyc.ai.cog.CogAdminServerApplication} 全量上下文。
     */
    ...
    @Import({
            ...
            GlobalExceptionHandlerTest.TestTraceConfiguration.class
    })
    static class WebMvcTestBootstrap {
    }
